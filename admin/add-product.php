                        ...
                        <div class="card-body">
                            ...
                            <div class="row">   
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" name="small_description" placeholder="Enter small     description" class="form-control mb-2">
                                    </textarea>
                                </div>
                                <div class="col-md-12">
                                    <label class="mb-0">Description</label>
                                    <textarea rows="3" name="description" placeholder="Enter description" class="form-control mb-2">
                                    </textarea>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea rows="3" name="meta_title" placeholder="Enter meta title" class="form-control mb-2">
                                    </textarea>
                                </div>
